...
SRCS	= ft_strlen.c ft_strlcpy.c ft_isalpha.c ft_isdigit.c ft_isalnum.c	\
		...
		ft_memset.c ft_memcpy.c ft_memmove.c ft_atoi.c ft_memcmp.c			\
		ft_memchr.c ft_memccpy.c ft_strlcat.c ft_strchr.c ft_strrchr.c		\
		ft_strncmp.c ft_strdup.c ft_calloc.c ft_substr.c ft_strnstr.c		\
